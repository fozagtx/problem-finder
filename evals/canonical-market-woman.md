# Canonical market-woman report

Source of truth for the live demo. ARTICLE.md, `skill/worked-example.md`, `/skill-demo`, and SUBMISSION.md must match this report. Do not drift. Do not invent a second example.
