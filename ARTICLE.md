...
1. Keep the messy original sentence.
2. Name the worker.
3. List what they do today.
4. Score fragmentation, incentive misalignment, incumbent neglect, and who bears the cost.
5. Reject the obvious framings out loud.
6. Write two or three one-sentence problems. Each sentence names the worker, the workaround, and the structural gap.

The sharpened problems, ranked:
